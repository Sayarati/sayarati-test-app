...
const copy = {
  en: {
    ...
    tourDone: "Done",
    tourCount: "Step",
    tourWelcomeTitle: "Welcome to Sayarati.online",
    tourWelcomeText: "This is your digital service booklet and online car care store. I will show you the app using sample data; when the tour ends, your real account will be empty and ready for your own cars.",
    ...
    tour1Title: "My Cars dashboard",
    tour1Text: "This is your garage dashboard. Your cars appear here with their photos, mileage, records, and quick actions.",
    tour2Title: "Add a car",
    tour2Text: "Tap here to create a new vehicle profile with brand, model, mileage, plate, and photo.",
    tour3Title: "View service history",
    tour3Text: "Use View history to open the maintenance records for the selected car.",
    ...
    tour5Text: "These black and yellow cards summarize your cars, service records, next service date, and total expenses.",
    ...
    tour7Text: "Open this tab to select a car, view its full maintenance history, and add new service records.",
    ...
    tour8Title: "Shop tab",
    tour8Text: "Browse car care products, categories, search, filters, product details, checkout, and share product links.",
    tour9Title: "Language",
    tour9Text: "Switch between English and Arabic from here.",
    tour10Title: "Profile",
    tour10Text: "Open your profile from the circle at the top. You can manage notifications, sign out, or delete your account there.",
  },
  ar: {
...
copy.ar = {
  ...
  tourDone: "تم",
  tourCount: "خطوة",
  tourWelcomeTitle: "أهلا بك في Sayarati.online",
  tourWelcomeText: "هذا هو دفتر الصيانة الرقمي ومتجر العناية بسيارتك. سنعرض لك جولة ببيانات تجريبية، وبعد انتهاء الجولة سيكون حسابك الحقيقي فارغا وجاهزا لسياراتك.",
  ...
  tour1Title: "لوحة سياراتي",
  tour1Text: "هذه لوحة مرآبك. تظهر سياراتك هنا مع الصور والعداد والسجلات والإجراءات السريعة.",
  tour2Title: "إضافة سيارة",
  tour2Text: "اضغط هنا لإنشاء ملف سيارة جديد مع الشركة والموديل والعداد واللوحة والصورة.",
  tour3Title: "عرض سجل الصيانة",
  tour3Text: "استخدم عرض السجل لفتح سجلات الصيانة الخاصة بالسيارة المختارة.",
  ...
  tour5Text: "هذه البطاقات السوداء والصفراء تلخص عدد السيارات والسجلات وموعد الصيانة القادم وإجمالي المصاريف.",
  ...
  tour7Text: "افتح هذا التبويب لاختيار السيارة، مشاهدة سجل الصيانة الكامل، وإضافة سجلات جديدة.",
  ...
  tour8Title: "المتجر",
  tour8Text: "تصفح منتجات العناية بالسيارة والفئات والبحث والفلاتر وتفاصيل المنتج والدفع ومشاركة روابط المنتجات.",
  tour9Title: "اللغة",
  tour9Text: "بدل بين الإنجليزية والعربية من هنا.",
  tour10Title: "الملف الشخصي",
  tour10Text: "افتح ملفك من الدائرة في الأعلى. يمكنك إدارة الإشعارات أو تسجيل الخروج أو حذف حسابك من هناك.",
};
