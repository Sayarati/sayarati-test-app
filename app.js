...
const SHOP_CACHE_KEY = "sayarati-shop-cache-v3";
...
async function loadShopCategories() {
  try {
    const data = await ecwidFetch("/categories", {
      limit: 100,
      responseFields: "items(id,name,enabled,productCount,thumbnailUrl,imageUrl,originalImageUrl,hdThumbnailUrl,orderBy),total",
    });
